...
###  v1.0.7.2:
 ...
 - #### 新增内容：
    ...
    - 全新的模组选项与键位设定！（核心代码来自Nebula）
    - 市长：添加选项 “市长票数”、“市长揭示后视野减少”。
 ...
 - #### 其它优化：
    ...
    - 删除船员职业：观察者
    - 删除伪装者职业：传教士
    - 删除 “船员、伪装者职业数量” 设定，由模组自动分配，以保证所有玩家必定获得职业。（除非职业数量不足）
    - 在会议中，市长揭示身份后，仍然可以被赌怪猜测其它身份，例如模仿者。
    - 如果刺客与专业刺客同时在一位玩家中，则隐藏刺客职业信息。（避免显示太多职业名称）
    - 如果开启选项 “通信破坏开启小黑人”，不会分配隐蔽者。
